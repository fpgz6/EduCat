<template>
	<div class="login_continer">
		...
		<input class="pass_input" type="text" placeholder="请输入用户名或手机号">
		<input class="pass_input" type="text" placeholder="请输入密码">
		<input class="pass_btn" type="submit" placeholder="立即登录">
		<p class="pass_tips">
